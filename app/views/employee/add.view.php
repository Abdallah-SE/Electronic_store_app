            ...
            <div class="empForm">
                <form class="appForm" method="post" enctype="application/x-www-form-urlencoded">
                    ...
                    <table>
                            ...
                            <tr>
                                <td>
                                    <input required type="text" name="name" id="name" placeholder="Write the employee name..." maxlength="55" value="">
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <input required type="number" id="age" name="age" min="23" max="60" value="">
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <input required type="text" id="address" name="address" placeholder="Write the employee address..." maxlength="100" value="">
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <input required type="number"  id="salary" step=".01" name="salary" min="1500" max="9000" value="">
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <input required type="number"  id="tax" step=".01" name="tax" min="1" max="5" value="">
                                </td>
                            </tr>
                            <tr>
                                <td>
